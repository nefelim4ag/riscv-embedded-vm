...
#define RISC_V_EVM_CALL_N3(N, A1, A2, A3)                                           \
    ({ register unsigned int _r  __asm__("a0");                              \
       register unsigned int _n  __asm__("a5") = (unsigned int)(N);          \
       register unsigned int _a1 __asm__("a0") = (unsigned int)(A1);         \
       register unsigned int _a2 __asm__("a1") = (unsigned int)(A2);         \
       register unsigned int _a3 __asm__("a2") = (unsigned int)(A3);         \
       __asm__ volatile ("ecall"                                              \
           : "=r"(_r)                                                        \
           : "r"(_n), "r"(_a1), "r"(_a2), "r"(_a3)                          \
           : "memory");                                                      \
       _r; })
...
#define RISC_V_EVM_CALL_N4(N, A1, A2, A3, A4)                                       \
    ({ register unsigned int _r  __asm__("a0");                              \
       ...
       register unsigned int _a2 __asm__("a1") = (unsigned int)(A2);         \
       register unsigned int _a3 __asm__("a2") = (unsigned int)(A3);         \
       register unsigned int _a4 __asm__("a3") = (unsigned int)(A4);         \
       __asm__ volatile ("ecall"                                              \
           : "=r"(_r)                                                        \
           : "r"(_n), "r"(_a1), "r"(_a2), "r"(_a3), "r"(_a4)               \
           : "memory");                                                      \
       _r; })
...
#define RISC_V_EVM_CALL_N5(N, A1, A2, A3, A4, A5)                                   \
    ({ register unsigned int _r  __asm__("a0");                              \
       ...
       register unsigned int _a3 __asm__("a2") = (unsigned int)(A3);         \
       register unsigned int _a4 __asm__("a3") = (unsigned int)(A4);         \
       register unsigned int _a5 __asm__("a4") = (unsigned int)(A5);         \
       __asm__ volatile ("ecall"                                              \
           : "=r"(_r)                                                        \
